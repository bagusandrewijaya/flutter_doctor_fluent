...
extension LKExampleExt on BuildContext {
  ...
  Future<bool?> showDisconnectDialog2() => flue.showDialog<bool>(
      barrierDismissible: true,
        context: this,
        builder: (ctx) => flue.ContentDialog(
            title: const Text('Akhir Panggilan'),
            content: const Text(
                'Ketika Panggilan Di Akhiri Maka Layanan Dengan Pasien Saat Ini Diakhiri',
            ),
            actions: [
                flue.Button(
